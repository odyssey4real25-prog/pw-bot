...
const COMMAND_CATEGORIES = [
  ...
  },
  {
    ...
    commands: [
      ...
      { cmd: '/treaty add',               desc: 'Record a treaty (MDP/ODP/Protectorate/NAP/etc) with another alliance' },
  ...
  },
  {
    ...
    commands: [
      ...
      { cmd: '/blitzplan generate',    desc: 'Auto-pair your members with enemy targets by war range and threat level — outputs a CSV plan' },
      { cmd: '/blitzplan convert',     desc: 'Convert a generated plan into a real blitz operation with assignments' },
      ...
      { cmd: '/operation warroom',   desc: 'Create dedicated private channels for an operation (main/assignments/intel/results)' },
      { cmd: '/operation archive',   desc: 'Lock a war room\'s channels but keep the history' },
      { cmd: '/operation deleteroom',desc: 'Permanently delete a war room\'s channels' },
